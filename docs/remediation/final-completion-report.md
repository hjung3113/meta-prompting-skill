...
run exposed that GitHub validates a synthetic merge revision. The record now
remains bound to its tested ancestor revision and is rejected whenever the
scenario contract surface changes; see [AD-003](autonomous-decision-log.md).
